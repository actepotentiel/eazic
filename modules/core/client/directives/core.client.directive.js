...
angular.module('core').directive('exploreContainer', function(){
    return {
        restrict: 'E',
        replace: true,
        templateUrl: 'modules/core/client/views/explore.client.view.html'
    };
});
angular.module('core').directive('playerContainer', function(){
    return {
        restrict: 'E',
        replace: true,
        templateUrl: 'modules/core/client/views/player.client.view.html'
    };
});
angular.module('core').directive('playlistContainer', function(){
    return {
        restrict: 'E',
        replace: true,
        templateUrl: 'modules/core/client/views/playlist.client.view.html'
    };
});
angular.module('core').directive('salonContainer', function(){
    return {
        restrict: 'E',
        replace: true,
        templateUrl: 'modules/core/client/views/salon.client.view.html'
    };
});
